...
#include "../../compression_types/element_wise_compression/element_wise_compression.hpp"
#include "../quantization.hpp"
#include "./element_wise_compression_modified_potential_new_interface.hpp"
...
int main(int argc, char* argv[]) {
	...
	compression_tile_type compression_tile{{x_min, y_min, 0}, tile_size};
	...
	queue.submit([&](celerity::handler& cgh) {
		...
		cgh.host_task(celerity::on_master_node, [=]() {
			auto vec = tile_points_acc.get_uncompressed_vec(tile_points_range);
